      ...
      <Card border='secondary' className='p-2 mb-4' style={{borderRadius: 0}}>
          ...
          <Card.Body className='p-0'  style={{fontSize: '1.8vw'}}>
            ...
            <div className="d-flex justify-content-between mb-2 mt-3">
              <p>Редкость:</p>
              <p className='border border-2 border-warning px-3 pb-1 rounded'>{post.rarity}</p>
            </div>
            <div className="d-flex justify-content-between">
              <p>Цена:</p>
              <p className='bg-warning px-4 rounded py-1'>от<span className='ms-1'/>{post.price}<i className="bi bi-currency-dollar"/></p>
            </div>
